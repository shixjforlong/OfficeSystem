...
define(function(require) {
    ...
    var TagModule = require("../components/tagoverviewforuser");
    var ContentModule = require("../components/content-tableforuser");
...
//        },
        ...
        _renderContent: function() {
            ...
            this.modules.content.addBtn.hide();
        },
        /*
            ...
            this.modules.tag.on({
                click: function(tag) {
                    ...
                    this.modules.content.render(this.service,tag,function(){
                        self.unmask();
                        self.modules.content.renderRowBackgroundColor();
                    });
                    this.modules.content.createGroupButton.hide();
                    this.modules.content.moveToGroupButton.hide();
                    this.modules.content.deleteFromBlackListButton.hide();
                },
                scope: this
            });
...
//                    validator.hideAll();
                    this.fire("afterRowClick",id,data);
                },
//                "delete": function() {
//                    this.modules.info.render(null);
//                    this.layout.close("east");
...
//                },
                ...
                "createGroup":function(){
                  this.fire("createGroup");
                },
                "moveToGroup":function(event){
                    this.fire("moveToGroup",event);
                },
                "deleteBlack":function(event){
                    this.fire("deleteBlack",event);
                },
                scope: this
            });
